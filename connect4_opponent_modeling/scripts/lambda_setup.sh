...
echo "  3. Run SFT warmup: python -m training.sft_train --model Qwen/Qwen3-4B-Base --data data/sft_warmup.jsonl --output_dir checkpoints/condition_a --epochs 3"
echo "  4. Check SFT gate: val_move_accuracy must be 35-65%"
echo "  5. Run preliminary: bash scripts/run_preliminary.sh"
echo "============================================"
