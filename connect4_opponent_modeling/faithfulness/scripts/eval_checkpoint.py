                    ...
                    json.dumps(
                        {
                            ...
                            "original_distribution": r.original_distribution,
                            "original_invalid_json_rate": r.original_invalid_json_rate,
                            "original_invalid_move_rate": r.original_invalid_move_rate,
                            "intervention_distributions": r.intervention_distributions,
                            "intervention_value_drops": r.intervention_value_drops,
                            "intervention_invalid_json_rates": r.intervention_invalid_json_rates,
                            "intervention_invalid_move_rates": r.intervention_invalid_move_rates,
